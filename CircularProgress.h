...
public:
    double value;
    QString text_timer;
    QFont font_timer = QFont("Arial Rounded MT Bold", 60, QFont::DemiBold);
...
protected:
    void paintEvent(QPaintEvent *) override {
        ...
        painter.setPen(QPen(QColor(0x4ECDC4), 10));
        painter.drawArc(rectangle, 0, 360 * 16);

        painter.setPen(QPen(QColor(0x1A535C), 10, Qt::SolidLine, Qt::RoundCap));
        painter.drawArc(rectangle, startAngle, spanAngle);
        painter.setPen(QPen(QColor(0x2E2E2E), 10));
